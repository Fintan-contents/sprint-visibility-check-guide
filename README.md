 ...
 * スプリントあたりのチーム開発時間算出シートを用いてチームの開発時間を算出します。  
    [スプリントあたりのチーム開発時間算出シート(EXCEL)](./docs/スプリントあたりのチーム開発時間算出シート.xlsx?raw=true)  
    [スプリントあたりのチーム開発時間算出シート(PDF)](./docs/スプリントあたりのチーム開発時間算出シート.pdf?raw=true)  
...
## 利用方法
 ...
 1. スプリントあたりのチーム開発時間算出シートを開いてください。  
    [スプリントあたりのチーム開発時間算出シート(EXCEL)](./docs/スプリントあたりのチーム開発時間算出シート.xlsx?raw=true)  
    [スプリントあたりのチーム開発時間算出シート(PDF)](./docs/スプリントあたりのチーム開発時間算出シート.pdf?raw=true)  
 1. スプリントあたりのチーム開発時間算出シートを用いてチームの開発時間を算出します。
